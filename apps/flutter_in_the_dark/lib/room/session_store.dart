...
/// /admin at all.
class SessionStore {
  // Renamed from 'fitd26.player' during WI-011 de-yearing. The old key is
  // deliberately NOT migrated: machines are shared between rounds, so the
  // forced re-join on next deploy is the desired reset.
  static const _key = 'fitd.player';
